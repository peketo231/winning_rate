...
Rails.application.config.sorcery.configure do |config|
  ...
  config.twitter.callback_url = Rails.env.production? ? 'https://werate.herokuapp.com/oauth/callback?provider=twitter' : 'http://localhost:3000/oauth/callback?provider=twitter'
